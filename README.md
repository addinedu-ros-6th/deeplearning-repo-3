...
|분류|기능|기능 설명|비고|
|-----|-----|-----|-----|
|주행 관련 객체 인식|장애물 인식 기능|전방 카메라의 영상 정보를 장애물 검출 모델로 송신하여 장애물을 인식|-|
|-|차선 인식 기능|차선 인식 카메라의 영상을 차선 검출 모델로 송신하여 차선을 인식|-|

|-|신호 인식 기능|신호등의 상태를 인식하며 메인 프로그램으로 송신|노란불 시간 여건상 미구현|
|-|표지판 인식 기능|다양한 표지판을 인식하여 메인 프로그램으로 송신|-|
|-|-|-|-|
### 시스템 설계
- 시스템 구조도
- 시나리오
